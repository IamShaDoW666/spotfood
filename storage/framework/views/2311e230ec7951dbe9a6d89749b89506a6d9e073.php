                                    ...
                                    <?php $__currentLoopData = $category->aitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href='javascript:;' onClick="setCurrentItem(<?php echo e($item->id); ?>)" class='item-offer-horizontal'>
                                            <div class='info'>
                                                ...
                                                <div class='extras'>
                                                    <div class='price'><?php echo money($item->price, config('settings.cashier_currency'),config('settings.do_convertion')); ?></div>
...
</section><?php /**PATH /var/www/desigalli/modules/ElegantTemplate/Providers/../Resources/views/templates/place-content.blade.php ENDPATH**/ ?>